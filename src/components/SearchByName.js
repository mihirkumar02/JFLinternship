                                ...
                                <div className="formbox">
                                    <form onSubmit={this.handleSubmit}>
                                        <div className="form-group">
                                          ...
                                          <input type="text" className="form-control" onChange={this.handleIdChange} placeholder="Enter store Name"/>
                                        </div>
                                        <div className="form-group">
...
export default connect(mapStateToProps, {searchOutletById, fetchOutletById})(SearchByName);
